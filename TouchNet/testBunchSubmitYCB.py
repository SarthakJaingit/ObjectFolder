...
#python testBunchSubmitYCB.py --data_root /viscam/u/rhgao/datasets/ObjectFiles/YCB/ycb --data_csv /viscam/u/rhgao/datasets/ObjectFiles/YCB.csv --num_of_jobs_to_submit 2
