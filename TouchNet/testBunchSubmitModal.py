...
#python testBunchSubmitModal.py --data_root /viscam/u/rhgao/datasets/ObjectFiles/modelhaven --data_csv /viscam/u/rhgao/datasets/ObjectFiles/modelhaven.csv --num_of_jobs_to_submit 2
...
def main():
	...
	for sub_split in job_splits:
		...
		slurm_file.write('#SBATCH --mem=150G\n')
