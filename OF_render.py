...
def config_parser():
    ...
    parser.add_argument("--object_file_path", type=str, default="Objects/23/ObjectFile.pth", help='ObjectFile path')
    ...
    parser.add_argument('--audio_batch_size', type=int, default=16384, help='input batch size')
    ...
    parser.add_argument('--touch_gelinfo_file_path', default='./data/touch_demo_vertices.npy', help='The path of the testing vertices file for touch, which should be a npy file.')
...
def AudioNet_eval(args):
    ...
    for i in trange(N):
        ...
        feat = librosa.feature.mfcc(y=signal, sr=44100)
        feat2save[i, :] = feat.flatten()
        # write wav file
