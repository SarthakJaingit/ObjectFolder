...
#python testBunchSubmitModel.py --data_root /viscam/u/rhgao/datasets/ObjectFiles/modelhaven --data_csv /viscam/u/rhgao/datasets/ObjectFiles/modelhaven.csv --num_of_jobs_to_submit 2
